module.exports = {
  ...
  langs: {
    en: {
      missingNickname: "Piw Piw Chat Bot Please enter the new nickname for the bot",
      changingNickname: "Piw Piw Chat Bot Start changing bot nickname to '%1' in %2 group chats",
      errorChangingNickname: "An error occurred while changing nickname in %1 groups:\n%2",
      successMessage: "✅ Piw Piw Chat Bot Successfully changed nickname in all group chats to '%1'",
      sendingNotification: "Piw Piw Chat Bot Sending notification to %1 group chats."
    }
  },
